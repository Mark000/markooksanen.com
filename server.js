...
(function() {
  var NotFound, connect, express, ghost, io, nodemailer, port, server;

  connect = require('connect', express = require('express', io = require('socket.io', port = process.env.PORT || 8081)));
